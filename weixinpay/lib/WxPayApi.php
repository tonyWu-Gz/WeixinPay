...
use myapp\weixinpay\lib\WxPayException;
use myapp\weixinpay\lib\WxPayConfigInterface;
use myapp\weixinpay\lib\WxPayDataBase;
use myapp\weixinpay\lib\WxPayDataBaseSignMd5;
use myapp\weixinpay\lib\WxPayResults;
use myapp\weixinpay\lib\WxPayNotifyResults;
use myapp\weixinpay\lib\WxPayNotifyReply;
use myapp\weixinpay\lib\WxPayUnifiedOrder;
use myapp\weixinpay\lib\WxPayOrderQuery;
use myapp\weixinpay\lib\WxPayCloseOrder;
use myapp\weixinpay\lib\WxPayRefund;
use myapp\weixinpay\lib\WxPayRefundQuery;
use myapp\weixinpay\lib\WxPayDownloadBill;
use myapp\weixinpay\lib\WxPayReport;
use myapp\weixinpay\lib\WxPayShortUrl;
use myapp\weixinpay\lib\WxPayMicroPay;
use myapp\weixinpay\lib\WxPayReverse;
use myapp\weixinpay\lib\WxPayJsApiPay;
use myapp\weixinpay\lib\WxPayBizPayUrl;
...
class WxPayApi {
    ...
    public static function unifiedOrder($config, $inputObj, $timeOut = 6) {
        ...
        $xml = $inputObj->ToXml();
        //error_log(print_r($inputObj,true), 3,'testxml.log');
    ...
    public static function notify($config, $callback, &$msg) {
        ...
        try {
            ...
            $result = WxPayNotifyResults::Init($config, $data);
